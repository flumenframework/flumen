...
/// The `flumen db` tool will create database tables for these types as long as they are visible
...
/// code flow.
///
/// Use the `flumen  auth` tool to add new clients to an application.
