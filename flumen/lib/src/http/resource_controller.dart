...
import 'package:flumen/src/auth/auth.dart';
...
///         }
///
/// Bindings will automatically parse values into other types and validate that requests have the desired values. See [Bind] for all possible bindings and TBD for more details.
///
