...
import 'package:flumen/src/db/query/mixin.dart';
export 'package:flumen/src/dev/context_helpers.dart';
...
class InMemoryAuthStorage extends AuthServerDelegate {
  ...
  void reset() {
    ...
    clients = {
      "com.flumenframework.app1": AuthClient("com.flumenframework.app1",
          AuthUtility.generatePasswordHash("kilimanjaro", salt), salt),
      "com.flumenframework.app2": AuthClient("com.flumenframework.app2",
          AuthUtility.generatePasswordHash("fuji", salt), salt),
      "com.flumenframework.redirect": AuthClient.withRedirectURI(
      ...
      "com.flumenframework.public":
          AuthClient("com.flumenframework.public", null, salt),
      "com.flumenframework.redirect2": AuthClient.withRedirectURI(
          "com.flumenframework.redirect2",
          AuthUtility.generatePasswordHash("gibraltar", salt),
          salt,
          "http://flumenframework.com/auth/redirect2"),
      "com.flumenframework.public.redirect": AuthClient.withRedirectURI(
          "com.flumenframework.public.redirect",
          null,
          salt,
          "http://flumenframework.com/auth/public-redirect"),
      "com.flumenframework.scoped": AuthClient.withRedirectURI(
          "com.flumenframework.scoped",
          AuthUtility.generatePasswordHash("kilimanjaro", salt),
          salt,
          "http://flumenframework.com/auth/scoped",
          allowedScopes: [AuthScope("user"), AuthScope("other_scope")]),
      "com.flumenframework.public.scoped": AuthClient.withRedirectURI(
          "com.flumenframework.public.scoped",
          null,
          salt,
          "http://flumenframework.com/auth/public-scoped",
          allowedScopes: [AuthScope("user"), AuthScope("other_scope")]),
    };
    users = {};
    tokens = [];
