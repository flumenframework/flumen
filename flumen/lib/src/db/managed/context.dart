...
import 'package:flumen/src/application/service_registry.dart';
import 'package:flumen/src/db/managed/data_model_manager.dart';
...
///
/// You create objects of this type to use the Flumen ORM. Create instances in [ApplicationChannel.prepare]
