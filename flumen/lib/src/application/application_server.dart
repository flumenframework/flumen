...
///
/// An Flumen application creates instances of this type to pair an HTTP server and an
...
class ApplicationServer {
  ...
  Logger get logger => Logger("flumen");
  ...
  Future didOpen() async {
    server.serverHeader = "flumen/$identifier";
    ...
    logger.info("Server flumen/$identifier started.");
  }
