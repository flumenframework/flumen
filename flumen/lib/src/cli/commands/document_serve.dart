...
class CLIDocumentServe extends CLICommand with CLIProject, CLIDocumentOptions {
  ...
  Directory get _hostedDirectory =>
      Directory.fromUri(projectDirectory.uri.resolve(".flumen_spec"));
...
<html>
  ...
  String get detailedDescription {
    return "This tool will start an HTTP server that serves an API reference web page. See `flumen  document --help` for configuration options.";
  }
}
