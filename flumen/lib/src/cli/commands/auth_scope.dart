...
import 'package:flumen/src/cli/mixins/database_connecting.dart';
import 'package:flumen/src/cli/mixins/database_managing.dart';
...
class CLIAuthScopeClient extends CLICommand
  ...
  String get description {
    return "Sets the scope of an existing OAuth 2.0 client in a database that has been provisioned with the flumen/managed_auth package.";
  }
}
