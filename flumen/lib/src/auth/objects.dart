...
///
/// See the flumen/managed_auth library for a concrete implementation of this type.
///
/// Use the command line tool `flumen  auth` to create instances of this type and store them to a database.
class AuthClient {
...
///
/// See the `package:flumen/managed_auth` library for a concrete implementation of this type.
class AuthToken {
...
///
/// An [AuthClient] has a list of valid scopes (see `flumen  auth` tool). An access token issued for an [AuthClient] may ask for
