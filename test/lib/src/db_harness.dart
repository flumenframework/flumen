...
/// Use methods from this class to test applications that use the Flumen ORM.
///
/// This class is mixed in to your [TestHarness] subclass to provide test
/// utilities for applications that use use the Flumen ORM. Methods from this class
