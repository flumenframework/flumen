...
import 'package:flumen_runtime/src/compiler.dart';
import 'package:flumen_runtime/src/mirror_context.dart';
...
class RuntimePackageCompiler extends Compiler {
  ...
  void deflectPackage(Directory destinationDirectory) {
    ...
    final contextFileContents = contextFile.readAsStringSync().replaceFirst(
        "import 'package:flumen_runtime/src/mirror_context.dart' as context;",
